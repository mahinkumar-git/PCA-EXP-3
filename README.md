...
## OUTPUT:
![image](https://github.com/user-attachments/assets/5469552e-6ee2-4cba-9b76-f1f74dfaf86d)


## RESULT:
Thus the program has been executed by using CUDA to perform sobel filtering.

Questions:

**What challenges did you face while implementing the Sobel filter for color images?**
Color images have three levels of data converting them to grayscale means we will have to properly average out
three values red green and blue bands. A proper algorithm was needed to bring out highlights and darks.

**How did changing the block size influence the performance of your CUDA implementation?**
Block sizes increases speed depending upon your GPUs cuda count. Once this threshold is reached then the perfomance starts to 
hit dimnishing returns.
